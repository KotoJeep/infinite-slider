...
console.log(
	'Повторить исходный проект - выполнено полностью \nОбязательный дополнительный фукционал - выполнено полностью \nДополнительный функционал на выбор - 1) пролистывание слайдера колесиком 2) пролистывание свайпами мыши(вверх, вниз) 3) видео вместо картинок(хром блокирует автовоспроизведение, нужно обновить страницу f5)'
);
